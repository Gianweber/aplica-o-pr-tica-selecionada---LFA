...
happyExpList = Happy_Data_Array.listArray (0,57) ([528,16,0,28960,528,29984,528,528,528,528,528,8192,0,0,0,24576,528,31008,528,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","num","'+'","'('","')'","and","if","then","else","or","'*'","'-'","%eof"]
        bit_start = st * 16
        bit_end = (st + 1) * 16
...
action_13 (6) = happyShift action_6
...
action_14 (6) = happyShift action_6
...
action_17 (6) = happyShift action_6
...
action_19 (6) = happyShift action_6
